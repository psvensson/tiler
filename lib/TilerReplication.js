...
(function() {
  ...
  TilerReplication = (function() {
    ...
    TilerReplication.REPLICA_REGISTRATION_EXPIRATION = 5;
    ...
    function TilerReplication(myAddress, cacheEngine, communicationManager) {
      ...
      console.log('TilerReplication created. address = ' + this.myAddress);
      this.oplogs = {};
      this.timers = {};
      this.replicas = {};
    }
        ...
        return function(siblings) {
          ...
          if (siblings.length === 0) {
            ...
            siblings.forEach(function(sibling) {
              var arr;
              if (debug) {
                console.log('checkMasterReplica sibling -> ' + sibling);
              }
              arr = sibling.split(',');
              if (debug) {
                console.dir(arr);
