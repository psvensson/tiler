...
(function() {
  var LRU, TilerReplication, debug, defer,
  ...
  TilerReplication = (function() {
    ...
    TilerReplication.prototype.setOurselvesAsReplica = function(zoneObj, kind) {
      ...
      return this.cacheEngine.set('zonereplica_' + zoneObj.tileid + ':' + this.myAddress, this.myAddress + "," + Date.now() + "," + kind);
    };
