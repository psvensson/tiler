...
(function() {
  ...
  Tiler = (function() {
    ...
    Tiler.prototype.addItem = function(level, item, doNotPropagate) {
      var q;
      q = defer();
      this.setSomething(level, item, this.zoneItemQuadTrees, q).then((function(_this) {
        return function() {
          if (!doNotPropagate) {
    ...
    Tiler.prototype.removeItem = function(level, item, doNotPropagate) {
      var q;
      q = defer();
      this.removeSomething(level, item, this.zoneItemQuadTrees, q).then((function(_this) {
    ...
    Tiler.prototype.addEntity = function(level, entity, doNotPropagate) {
      var q;
      q = defer();
      this.setSomething(level, entity, this.zoneEntityQuadTrees, q).then((function(_this) {
        return function(zoneObj) {
          if (!doNotPropagate) {
    ...
    Tiler.prototype.removeEntity = function(level, entity, doNotPropagate) {
      var q;
      q = defer();
      this.removeSomething(level, entity, this.zoneEntityQuadTrees, q).then((function(_this) {
        return function(zoneObj) {
          if (!doNotPropagate) {
    ...
    Tiler.prototype.setSomething = function(level, something, qthash, q) {
      var qq;
      qq = defer();
    ...
    Tiler.prototype.removeSomething = function(level, something, qthash, q) {
      var qq;
      qq = defer();
      this.resolveZoneFor(level, something.x, something.y).then((function(_this) {
        return function(zoneObj) {
