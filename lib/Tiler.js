...
(function() {
  ...
  Tiler = (function() {
    ...
    Tiler.prototype.registerZone = function(q, zoneObj) {
      var arr, cbs, entityQT, itemQT, x, y, ztiles;
      ...
      this.siblings.registerAsSiblingForZone(zoneObj);
      if (this.zoneUnderConstruction[zoneObj.tileid] = true) {
        delete this.zoneUnderConstruction[zoneObj.tileid];
        cbs = this.postContructionCallbacks[zoneObj.tileid] || [];
        cbs.forEach((function(_this) {
          return function(cb) {
            return cb();
          };
        })(this));
